function formatPhoneNumberUSA(number) {
  ...
  const formattedNumber = formatPhoneNumberUSA(number);
  console.log(formattedNumber);
  console.log(formatPhoneNumberUSA(1234567890))
  
  console.log(formatPhoneNumberUSA(123456789021))